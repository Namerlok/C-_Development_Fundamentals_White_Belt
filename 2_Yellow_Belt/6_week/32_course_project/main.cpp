...
void TestAll() {
	...
	tr.RunTest(TestNodeDateComparison, "TestDateComparisonNode");
	tr.RunTest(TestNodeEventComparison, "TestEventComparisonNode");
	tr.RunTest(TestNodeLogicalOperation, "TestLogicalOperationNode");
...
void TestParseEvent() {
	...
	}
	{
		...
		events.push_back(ParseEvent(is));
		AssertEqual(events,
					vector<string>{"first event  ", "second event"},
